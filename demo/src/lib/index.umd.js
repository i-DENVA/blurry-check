!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define(['exports'], t)
      : t(((e = 'undefined' != typeof globalThis ? globalThis : e || self).BlurryCheck = {}));
})(this, function (e) {
  'use strict';
  function t() {
  ...
  async function n(e, n) {
        ...
        (a.onload = (e) => {
          ...
          (s.onload = () => {
            (i.width = s.width),
              (i.height = s.height),
              o.drawImage(s, 0, 0),
              t(o.getImageData(0, 0, i.width, i.height));
          }),
            (s.onerror = n),
            (s.src = null === (a = e.target) || void 0 === a ? void 0 : a.result);
        }),
          (a.onerror = n),
          a.readAsDataURL(e);
      });
    if (e instanceof HTMLImageElement)
      return (
        (i.width = e.naturalWidth || e.width),
        (i.height = e.naturalHeight || e.height),
        o.drawImage(e, 0, 0),
        o.getImageData(0, 0, i.width, i.height)
      );
    if (e instanceof HTMLCanvasElement) {
      const t = e.getContext('2d');
      if (!t) throw new Error('Could not get 2D context from source canvas');
  ...
  class o {
    ...
    static getInstance(e) {
      return o.instance || (o.instance = new o(e)), o.instance;
    }
    async loadOpenCV() {
          ...
          await (function (e) {
            return new Promise((t, n) => {
              ...
              e.addEventListener(
                ...
                e.addEventListener('error', () => n(new Error('OpenCV script failed')), {
                  once: !0,
                });
            });
          })(e),
  ...
  class u {
    constructor(e = {}) {
      var n, i, a, s, r, l;
      (this.config = {
        edgeWidthThreshold: null !== (n = e.edgeWidthThreshold) && void 0 !== n ? n : 0.3,
        laplacianThreshold: null !== (i = e.laplacianThreshold) && void 0 !== i ? i : 150,
        method: null !== (a = e.method) && void 0 !== a ? a : 'both',
        openCvUrl:
          null !== (s = e.openCvUrl) && void 0 !== s
            ? s
            : 'https://docs.opencv.org/4.5.4/opencv.js',
        canvas: null !== (r = e.canvas) && void 0 !== r ? r : t(),
        debug: null !== (l = e.debug) && void 0 !== l && l,
      }),
        (this.openCvLoader = o.getInstance(this.config.openCvUrl));
    }
    log(e, ...t) {
      this.config.debug && console.log(`[BlurDetector] ${e}`, ...t);
    }
    detectEdges(e) {
      const t = i.luminance(e);
      return i.convolve(t, i.getFloat32Array([1, 0, -1, 2, 0, -2, 1, 0, -1]), !0);
    }
    reducedPixels(e) {
    ...
    detectBlur(e) {
      ...
      if (0 === i)
        return { width: t, height: n, numEdges: 0, avgEdgeWidth: 0, avgEdgeWidthPerc: 0 };
      const a = o / i;
    ...
    async analyzeImage(e) {
      ...
      const t = await n(e, this.config.canvas),
        i = { isBlurry: !1, confidence: 0, metrics: {}, method: this.config.method };
      try {
        if ('edge' === this.config.method || 'both' === this.config.method) {
          const e = this.detectBlur(this.reducedPixels(this.detectEdges(t)));
          i.metrics.edgeAnalysis = e;
          const n = e.avgEdgeWidthPerc > this.config.edgeWidthThreshold,
            o = e.numEdges < (t.width * t.height) / 1e4,
            a = n || o;
        ...
        if ('laplacian' === this.config.method || 'both' === this.config.method)
          try {
            const e = await this.detectBlurOpenCV(t);
            i.metrics.laplacianVariance = e;
            const n = e < this.config.laplacianThreshold;
            this.log('Laplacian:', e, 'blurry:', n),
              'laplacian' === this.config.method &&
                ((i.isBlurry = n),
                (i.confidence = Math.min(this.config.laplacianThreshold / e, 1)));
          } catch (e) {
            if (
          ...
          const e = i.metrics.edgeAnalysis,
            n =
              ...
              (e.avgEdgeWidthPerc > this.config.edgeWidthThreshold ||
                e.numEdges < (t.width * t.height) / 1e4),
  ...
  function w(e, t, n, i) {
    const o = f(t);
    return { ok: e, status: y(e, o), score: o, message: n, details: i };
  }
  class v {
    constructor(e = {}) {
      (this.pdfLib = null), (this.loading = !1), (this.config = e), (this.blurDetector = new u(e));
    }
    ...
    estimatePerspectiveScore(e) {
      ...
      const r = Math.floor(o.length / 4),
        ...
        u = 1 - Math.min(1, 15 * m);
      return Math.round(p(100 * (0.7 * h + 0.3 * u)));
    }
    log(e, ...t) {
      ...
      return {
        ...
        metrics: {
          ...
          scaleResults: r.map((e) => {
            ...
            return {
              scale: parseFloat(
                (null === (t = e.method.match(/scale ([\d.]+)x/)) || void 0 === t
                  ? void 0
                  : t[1]) || '1',
              ),
              isBlurry: e.isBlurry,
  ...
  function B(e) {
    var t;
    return null !== (t = S[e]) && void 0 !== t ? t : 'general';
  }
  const L = ['image/jpeg', 'image/png', 'image/webp', 'image/gif', 'image/bmp', 'application/pdf'],
    D = ['jpg', 'jpeg', 'png', 'webp', 'gif', 'bmp', 'pdf'],
    T = [
  ...
  function z(e) {
    var t;
    return (
      (null === (t = e.name.split('.').pop()) || void 0 === t ? void 0 : t.toLowerCase()) || ''
    );
  }
  function E(e, t) {
    return e ? 'pass' : t >= 60 ? 'warning' : 'fail';
  ...
  async function W(e, t = {}) {
    ...
    const r =
      ...
      l = null !== (o = t.allowedTypes) && void 0 !== o ? o : L,
      c = null !== (a = t.allowedExtensions) && void 0 !== a ? a : D,
      d = z(e),
      h = [],
    ...
    const m = 0 === l.length || l.includes(e.type),
      u = 0 === c.length || c.includes(d);
    if (
      ((m && u) || h.push('unsupported_format'),
    ...
    const f = 0 === h.length,
      y = f ? 100 : Math.round(p(100 - 30 * h.length, 0, 100));
    return {
      ok: f,
      status: E(f, y),
      score: y,
  ...
  const j = ['file', 'format', 'fileSize', 'resolution', 'blur', 'brightness', 'contrast'];
  function F(e) {
    return e.maxLuminance < c || (e.contentBrightness < d && e.maxLuminance < h);
  }
  function R(e) {
    return e.brightness < 50 || F(e)
      ? 'too_dark'
      : (function (e) {
            return e.glarePixelRatio >= m && e.maxLuminance >= g && e.contrast >= 80;
          })(e)
        ? 'glare'
        : e.brightness > a &&
            !(function (e) {
  ...
  async function I(e, t = {}) {
        ...
        return {
          ..._(
            null !== (t = e.mode) && void 0 !== t
              ? t
              : B(null !== (n = e.preset) && void 0 !== n ? n : 'general'),
            null !== (i = e.strictness) && void 0 !== i ? i : 'medium',
          ),
          ...e,
        };
      })(t),
      T = null !== (i = D.checks) && void 0 !== i ? i : j,
      z = {},
      E = [];
    if (e instanceof File && T.some((e) => ['file', 'format', 'fileSize'].includes(e))) {
      const t = await W(e, {
        ...D,
        allowedTypes:
          null !== (o = D.allowedTypes) && void 0 !== o
            ? o
            : ['image/jpeg', 'image/png', 'image/webp', 'image/gif', 'image/bmp'],
        allowedExtensions:
          null !== (p = D.allowedExtensions) && void 0 !== p
            ? p
      ...
      if (
        (T.includes('format') &&
          (z.format = { ...t, details: { ...t.details, category: 'format' } }),
        T.includes('fileSize'))
      ) {
        const t =
            null !== (y = D.maxSizeBytes) && void 0 !== y
              ? y
              : 1024 * (null !== (v = D.maxSizeMB) && void 0 !== v ? v : 10) * 1024,
          n = e.size > 0 && e.size <= t;
        n || E.push('too_large'),
          (z.fileSize = w(n, n ? 100 : 50, n ? 'File size is acceptable.' : 'File is too large.', {
            size: e.size,
            maxSizeBytes: t,
          }));
      }
    }
    const I = await n(e, D.canvas),
      $ = (function (e) {
        const { data: t } = e;
        let n = 0,
          i = 0,
    ...
    if (T.includes('resolution')) {
      const e = (function (e, t, n, i, o) {
        ...
        I,
        null !== (b = D.minWidth) && void 0 !== b ? b : 600,
        null !== (x = D.minHeight) && void 0 !== x ? x : 600,
        D.maxWidth,
        D.maxHeight,
      );
      e.ok || E.push('low_resolution'), (z.resolution = w(e.ok, e.ok ? 100 : 50, e.msg, e.details));
    }
    if ((A && E.push('blank_image'), T.includes('brightness'))) {
      const e = A ? void 0 : R($);
      e && E.push(e),
        (z.brightness = (function (e, t) {
          return w(
                ...
                : 'Brightness looks good.',
            {
              ...
              glarePixelRatioThreshold: m,
              glareLuminanceThreshold: g,
              documentMaxLuminanceMin: c,
              documentContentBrightnessMin: d,
              documentContentMaxLuminanceMin: h,
            },
          );
        })($, e));
    }
    if (T.includes('contrast')) {
      const e = (function (e) {
        const t = e.nonWhiteRatio >= s && e.contentBrightness < r && e.contentContrast >= l,
          n = e.contrast >= 22 || t;
        return w(
          n,
          (e.contrast / 55) * 100,
            ...
            : 'Image has low contrast.',
          {
            ...
            contentBrightness: e.contentBrightness,
            contentContrast: e.contentContrast,
            readableContentMinContrast: l,
            contrastReadableContentMinContrast: l,
          },
        );
      })($);
      e.ok || A || E.push('low_contrast'), (z.contrast = e);
    }
    if (T.includes('blur')) {
      O = await new u(D).analyzeImage(I);
      const e = (function (e, t, n) {
        var i;
        const o =
            null === (i = e.metrics.edgeAnalysis) || void 0 === i ? void 0 : i.avgEdgeWidthPerc,
        ...
        return (
          ...
          w(!e.isBlurry, s, e.isBlurry ? 'Image appears blurry.' : 'Sharpness looks good.', {
            confidence: e.confidence,
            method: e.method,
            edgeWidthPerc: o,
            laplacianVariance: a,
        ...
        null !== (k = D.laplacianThreshold) && void 0 !== k ? k : 150,
      );
      (z.blur = e), e.ok || A || E.push('blurry');
    }
    const V = [...new Set(E)],
      H = Object.values(z).filter(Boolean),
      U = f(H.length ? H.reduce((e, t) => e + t.score, 0) / H.length : 100),
      G = null !== (S = D.minScore) && void 0 !== S ? S : 70,
      q = 0 === V.length && U >= G;
    return {
      valid: q,
      ok: q,
      ...
      blurAnalysis: O,
      debugMetrics: {
        mode: null !== (L = t.mode) && void 0 !== L ? L : 'general',
        ...
        resolvedThresholds: {
          ...
          contrast: { readableContentMinContrast: l, contrastReadableContentMinContrast: l },
        },
      },
    };
  }
  const $ = new Set(['ocr', 'ai-input']);
  function A(e) {
    return !['scanned_pdf', 'cover_page'].includes(e);
  }
  async function O(e, t = {}, n = {}) {
    var i, o, u, p, b, x, C, k, S, L, D;
    const T =
        null !== (i = t.mode) && void 0 !== i
          ? i
          : B(null !== (o = t.preset) && void 0 !== o ? o : 'document'),
      z = {
        ..._(T, null !== (u = t.strictness) && void 0 !== u ? u : 'medium'),
        ...t,
        mode: T,
        strictness: t.strictness,
      },
      E = await W(e, { ...z, allowedTypes: ['application/pdf'], allowedExtensions: ['pdf'] }),
      j =
        null !== (p = z.maxSizeBytes) && void 0 !== p
          ? p
          : 1024 * (null !== (b = z.maxSizeMB) && void 0 !== b ? b : 15) * 1024,
      F = e.size > 0 && e.size <= j,
      R = w(F, F ? 100 : 45, F ? 'PDF size is acceptable.' : 'PDF too large.', {
        size: e.size,
        maxSizeBytes: j,
      });
    if (!E.ok) {
      ...
      return {
        ...
        ok: !1,
        status: 'fail',
        score: Math.min(E.score, R.score),
        message: M(e),
        type: 'pdf',
        checks: { file: E, fileSize: R },
        issues: e,
        warnings: [],
        recommendations: P(e),
      };
    ...
    try {
      ...
      return {
        ...
        status: 'fail',
        score: 0,
        message: M(['corrupted_pdf']),
        type: 'pdf',
        checks: {
          file: E,
          fileSize: R,
          corruptedPages: w(!1, 0, 'PDF could not be read.', {
            error: e instanceof Error ? e.message : 'Unknown',
          }),
        },
        issues: ['corrupted_pdf'],
        warnings: [],
        recommendations: P(['corrupted_pdf']),
        debugMetrics: { error: e instanceof Error ? e.message : 'Unknown' },
      };
    }
    const O = (null !== (C = I.pageResults) && void 0 !== C ? C : []).map((e, t) =>
        (function (e, t, n) {
          var i, o, u, p, v, b, x;
          const P = t.metrics.pdfPageMetrics,
            ...
            S = null !== (o = n.minHeight) && void 0 !== o ? o : 1e3,
          ...
          const D =
            ...
            T = P.maxLuminance < c || (P.contentBrightness < d && P.maxLuminance < h),
            z =
              P.glarePixelRatio >= m &&
          ...
          (M.brightness = w(
            ...
            E && C.push(E);
          const W = P.nonWhiteRatio >= s && P.contentBrightness < r && P.contentContrast >= l,
            j = P.contrast >= 22 || W;
          (M.contrast = w(
            j,
            (P.contrast / 55) * 100,
            ...
            j || C.push('low_contrast');
          const F = P.documentFrame;
          F.isLikelyCropped && C.push('cropped'),
            F.hasPerspectiveDistortion && C.push('perspective_distortion');
          const R = F.detected && !F.isLikelyCropped && !F.hasPerspectiveDistortion;
          M.mobileCapture = w(
            R,
            R ? 100 : Math.min(F.perspectiveScore, F.isLikelyCropped ? 55 : 75),
            R
          ...
          const I = n.expectedOrientation,
            A = !I || P.orientation === I || 'square' === P.orientation;
          (M.orientation = w(
            A,
            A ? 100 : 55,
            I
            ...
            { orientation: P.orientation, expected: I, rotation: P.rotation },
          )),
            !A && I && C.push('rotated'),
            (M.sharpness = w(
              !t.isBlurry,
              ...
              t.isBlurry ? `Page ${e} is blurry.` : 'Sharpness looks good.',
              {
                ...
                edgeWidthPerc:
                  null === (p = t.metrics.edgeAnalysis) || void 0 === p
                    ? void 0
                    : p.avgEdgeWidthPerc,
                textSharpnessScore:
          ...
          const O = t.metrics.contentAnalysis,
            V = null !== (b = null == O ? void 0 : O.hasLowTextContent) && void 0 !== b && b,
            H = null !== (x = null == O ? void 0 : O.isCertificateDocument) && void 0 !== x && x,
            U = !V || H;
          (M.textDensity = w(
            U,
            U ? 100 : 65,
      ...
      V = null !== (k = I.corruptedPages) && void 0 !== k ? k : [],
      H = [],
      U = [];
    F || H.push('too_large'),
      V.length > 0 && H.push('corrupted_page'),
      (null === (S = I.skippedPages) || void 0 === S ? void 0 : S.length) &&
        H.push('corrupted_page'),
      I.isScanned && U.push('scanned_pdf');
    const G = O.flatMap((e) => e.issues),
      ...
      N = [],
      J = [...[...new Set([...U, ...q])]];
    for (const e of Q) (A(e) ? N : J).push(e);
    const Y = [...new Set(N)],
      K = [...new Set(J)],
      X = w(
        !0,
        ...
        { isScanned: I.isScanned, textLength: I.textLength },
      ),
      Z = w(
        0 === V.length,
        0 === V.length ? 100 : 35,
      ...
      te = f([E.score, R.score, X.score, Z.score, ee].reduce((e, t) => e + t, 0) / 5),
      ne = null !== (L = z.minScore) && void 0 !== L ? L : 72,
      ie = 0 === Y.length && I.isQualityGood && te >= ne;
    return {
      valid: ie,
      ok: ie,
      status: y(ie, te),
      ...
      debugMetrics: {
        ...
        incomplete: null !== (D = I.incomplete) && void 0 !== D && D,
        incompleteReason: I.incompleteReason,
        totalPages: I.totalPages,
        skippedPages: I.skippedPages,
      },
    };
  }
  class V {
    constructor(e = {}) {
      (this.config = {
        ...
        (this.blurDetector = new u(this.config)),
        (this.pdfAnalyzer = new v(this.config));
    }
    ...
    async analyzeFile(e, t = {}) {
      const n = z(e),
        i = { ...this.config, ...t };
      if ('pdf' === n) return new v(i).analyzePDF(e);
      if (['png', 'jpg', 'jpeg', 'gif', 'bmp', 'webp'].includes(n)) return new u(i).analyzeImage(e);
      throw new Error(`Unsupported file type: ${n}`);
    }
    async validateImage(e, t = {}) {
      return I(e, { ...this.config, ...t });
    }
  ...
  (e.BlurDetector = u),
    ...
    (e.OpenCVLoader = o),
    (e.PDFAnalyzer = v),
    (e.analyzeFile = async function (e, t) {
      return new V(t).analyzeFile(e, t);
    }),
    (e.default = V),
    (e.isImageBlurry = async function (e, t) {
      return new V(t).isImageBlurry(e);
    }),
    (e.isPDFGoodQuality = async function (e, t) {
      return new V(t).isPDFGoodQuality(e);
    }),
    (e.presetToMode = B),
    (e.recommendationsFor = P),
    (e.resolveMode = _),
    (e.summaryFor = M),
    (e.validateImage = async function (e, t) {
      return new V(t).validateImage(e, t);
    }),
    (e.validateUpload = async function (e, t) {
      return new V(t).validateUpload(e, t);
    }),
