...
const E = ['file', 'format', 'fileSize', 'resolution', 'blur', 'brightness', 'contrast'];
function j(e) {
  return e.maxLuminance < l || (e.contentBrightness < c && e.maxLuminance < d);
}
function F(e) {
  return e.brightness < 50 || j(e)
    ? 'too_dark'
    : (function (e) {
...
async function R(e, n = {}) {
  ...
  const D = (function (e) {
    ...
    T = null !== (i = D.checks) && void 0 !== i ? i : E,
    z = {},
    R = [];
  ...
  return {
    ...
    debugMetrics: {
      ...
      contrast: I.contrast,
      minLuminance: I.minLuminance,
      maxLuminance: I.maxLuminance,
      minScore: G,
      nonWhiteRatio: I.nonWhiteRatio,
      contentContrast: I.contentContrast,
      blank: {
        detected: A,
...
async function A(e, t = {}, n = {}) {
  ...
  const T =
    ...
    F = e.size > 0 && e.size <= j,
    R = y(F, F ? 100 : 45, F ? 'PDF size is acceptable.' : 'PDF too large.', {
      size: e.size,
      maxSizeBytes: j,
    });
  if (!E.ok) {
  ...
  try {
    ...
    return {
      ...
      warnings: [],
      recommendations: x(['corrupted_pdf']),
  ...
  const O = (null !== (C = A.pageResults) && void 0 !== C ? C : []).map((e, t) =>
      (function (e, t, n) {
        ...
        (M.brightness = y(
          ...
          W && C.push(W);
        const E = P.nonWhiteRatio >= a && P.contentBrightness < s && P.contentContrast >= r,
          j = P.contrast >= 22 || E;
        (M.contrast = y(
          j,
          (P.contrast / 55) * 100,
  ...
  const G = O.flatMap((e) => e.issues),
    ...
    N = [],
    J = [...[...new Set([...U, ...q])]];
  for (const e of Q) (I(e) ? N : J).push(e);
  const Y = [...new Set(N)],
    K = [...new Set(J)],
    X = y(
      !0,
    ...
    te = p([E.score, R.score, X.score, Z.score, ee].reduce((e, t) => e + t, 0) / 5),
...
export {
  ...
  O as default,
  V as isImageBlurry,
  H as isPDFGoodQuality,
  S as presetToMode,
  x as recommendationsFor,
  k as resolveMode,
  P as summaryFor,
  G as validateImage,
  q as validateUpload,
